...
import com.example.matrixassignment.countriesdatascreen.utils.Utils.isNetworkAvailable
    ...
    suspend fun downloadAudioFile(audioFileData: AudioFileData, networkCallback: NetworkCallback<ResponseBody>) {
        try {
            ...
            if (response.isSuccessful) {
                ...
                Log.e(
                    TAG, "Audio file ${audioFileData.name} download error: " + response.errorBody()
                    .toString())
