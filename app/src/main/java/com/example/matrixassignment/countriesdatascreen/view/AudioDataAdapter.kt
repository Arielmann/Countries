...
import com.example.matrixassignment.countriesdatascreen.adapterhelpers.DefaultDiffUtilCallback
import com.example.matrixassignment.countriesdatascreen.model.AudioFileData
import com.example.maytronicstestapp.R
import com.example.maytronicstestapp.databinding.VhAudioDataListBinding
import java.lang.ref.WeakReference

/**
 * Adapter for managing the display of the [AudioFileData]
 */
class AudioDataAdapter(context: Context) : ListAdapter<AudioFileData, AudioDataAdapter.AudioDataViewHolder>(
    DefaultDiffUtilCallback<AudioFileData>()
) {
